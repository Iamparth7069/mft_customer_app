...
class BottomSheetSelectAddress extends StatelessWidget {
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context,index){
                    Address addressModel = controller.addressModelList[index];
                    return addressView(addressModel,controller);
                  },
                ),
                Container(
                  height: 80,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        commonButtonWithBoarder(title: AppText.addNewAddress),
                      ],
                    ),
                  ),
                ),
